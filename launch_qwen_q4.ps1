# Usage: .\launch_qwen_q4.ps1         -> fast mode (128k context, fully in VRAM)
#        .\launch_qwen_q4.ps1 -long   -> long context mode (256k, q8_0 KV cache)
param([switch]$long)
...
& "H:\llama.cpp\llama.cpp_setup\llama-server.exe" `
  --model "H:\llama.cpp\models\Qwen3.6-35B-A3B-UD-Q4_K_M.gguf" `
